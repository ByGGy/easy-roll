...
type DeadlandsRollStat = 'Attribute' | 'Ability'
...
type Props = {
  ...
  rollStat: DeadlandsRollStat
  statName: string
  initDifficulty?: number
  initModifier?: number
}

export const DeadlandsRoll = ({ characterId, rollStat, statName, initDifficulty= DEFAULT_DIFFICULTY, initModifier= DEFAULT_MODIFIER }: Props) => {
  ...
  useEffect(() => {
    window.electronAPI.onMessage('Domain.Deadlands.successRatio', setSuccessRatio)
  }, [])
              ...
              <Stack gap={4}>
                <Box>
                  ...
                  <Slider
                    ...
                    marks
                    sx={{
                      color: evaluateModifierColor(-difficulty)
                    }}
                  />
                </Box>
                <Box>
